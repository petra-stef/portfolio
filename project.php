...
<div onclick="topFunction()" id="back-to-top" title="Go to top"><img src="img/arrow-up.svg" alt=""></div>
  ...
  <p id="paragraphs" class="wow fadeIn">Nowadays people are eating out more or buying processed or frozen foods because they think cooking is too time-consuming and requires a lot of skills.
    ...
    after not using them all they have to thrown them away. <span style="color:#a9a9a9;">(In the US, 30-40% of the food is wasted. Source: usda.gov)</span></p>

  <h2 id="headlines">What do potential users think? (Interviews)</h2>

  <div class="interviews wow fadeIn">
    <div>
  ...
  <div id="subgoals" class="wow fadeIn" data-wow-duration="2s">
  ...
  <div class="persona wow fadeIn"><img src="./img/persona1.png" alt=""></div>
  ...
  <figure class="wow fadeIn"><img src="./img/zoomin.jpg" alt="">
    <figcaption>A snippet of the user flow.</figcaption>
  </figure>
